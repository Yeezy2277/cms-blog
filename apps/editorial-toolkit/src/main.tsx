...
// hub's preview modal, so an iframe check alone can't tell them apart. The
// public playground is forced explicitly with `?demo=1` (the hub embeds that
// URL); direct opens (no iframe) get the playground too.
